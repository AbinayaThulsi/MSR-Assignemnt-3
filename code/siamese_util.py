...
from input_handler import TextCNNInputHandler, RNNInputHandler, BasicInputHandler
from preprocessing import loadFilters, MultiLineTokenizer, PreprocessingCache, SummaryDescriptionPreprocessor, \
    DescriptionPreprocessor, SummaryPreprocessor
from attention import SelfAttention
from basic_module import TextCNN, MultilayerDense, SortedRNNEncoder, RNNFixedOuput, RNN_Self_Attention, \
    Dense_Self_Attention
from siamese import CategoricalEncoder, WordMean
...
def processSumParam(sumOpts, bugReportDatabase, inputHandlers, preprocessors, encoders, databasePath, cacheFolder,
                    logger, paddingSym):
    # Use summary and description (concatenated) to address this problem
    ...
    if sumOpts['encoder_type'] == 'rnn':
        ...
        sumRNN = SortedRNNEncoder(rnnType, embedding, hiddenSize, numLayers, bidirectional, updateEmb,
                                  dropout)
